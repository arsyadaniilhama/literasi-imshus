    ...
    <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6 sm:py-14">
      <div className="text-center">
        ...
        <p className="mt-4 text-lg leading-relaxed text-muted-foreground">
          {SCHOOL_SHORT} adalah platform publikasi tulisan santri di lingkungan
          pesantren IMSHUS Isy Karima. Kami percaya bahwa setiap santri memiliki
          suara dan karya yang layak dibaca banyak orang.
        </p>
      </div>
